// Connect to geojson USGS information using D3
...
function createFeatures(earthquakeInfo) {
  ...
  // Create pop-up with the magnitude and location
  ...
  function createMap(earthquakes) {
    ...
    // Create our map, with the coordinates of the geographical center of the US
    let myMap = L.map("map", {
      center: [39.50, -98.35],
      zoom: 4,
